...
export const APP_UPDATES: AppUpdate[] = [
  {
    ...
    isoDate: "2026-08-31",
    title: "Corrección Integral en Edición de Pedidos de Caja y Domicilios",
    subtitle: "Resolución del error de localizador obligatorio, carga directa sin parpadeos y redirección inteligente.",
    badgeText: `🛠️ v${pkg.version}`,
    badgeType: "amber",
    gradientTheme: "sunset",
    isMajor: false,
    summary: "Se corrigió el error que impedía guardar cambios en pedidos pendientes de Caja y Domicilios debido a la ausencia del localizador en el envío al servidor. Además, se integró carga directa con indicador visual de espera para evitar parpadeos de selección y se configuró la redirección automática al completar la edición.",
